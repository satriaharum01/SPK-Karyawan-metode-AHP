<x-app-layout>
    ...
    <div class="container-fluid py-2">
        <div class="row">
            ...
            <div class="card col-12 p-4">
                <h4 class="mb-2">List Kuesioner Subkriteria</h4>
                <div class="col-12">
                    <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal">
                        Tambah Kuesioner
                    </button>
                    <a type="button" class="btn btn-warning" href="{{ route('subcriteria', ['criteriaId' => $criteriaId]) }}">
                        Kembali
                    </a>
                </div>
    ...
    <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <form method="POST" action="{{ route('subcriteria.quesioner.store') }}">
                @csrf
                <div class="modal-content">
                    ...
                    <input type="hidden" name="id_criteria" value="{{$criteriaId}}">
                    ...
                    @foreach($subcriteria as $low)
                        ...
                        <div class="align-content-center text-center d-flex justify-content-between mb-3">
                            ...
                            <input type="hidden" name="responden[{{$i}}][id_subcriteria]" value="{{$low->id}}">
                            ...
                            <input type="hidden" name="responden[{{$i++}}][id_comparison_subcriteria]" value="{{$row->id}}">
                        </div>
                            @endif
                        @endforeach
                        @endif
...
<script>
    $(document).ready(function() {
        $('.delete-link').click(function(e) {
            ...
            var formAction = "{{ route('subcriteria.quesioner.destroy', ['name' => ':name','criteriaId'=> $criteriaId]) }}";
        ...
        $('.edit-link').click(function(e) {
            ...
            var url = "{{ route('subcriteria.quesioner.edit', ['name' => ':name','criteriaId'=> $criteriaId]) }}";
            ...
            var formActionEdit = "{{ route('subcriteria.quesioner.update', ['name' => ':name']) }}";
