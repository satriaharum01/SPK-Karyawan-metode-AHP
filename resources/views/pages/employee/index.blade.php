    ...
    <div class="container-fluid py-2">
        <div class="row">
            <div class="card col-12 p-4">
                <h4 class="mb-2">List Guru</h4 class="mb-2">
                <div class="col-12">
                    <button type="button" id="buttonCreate" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal">
                        Tambah Guru
                    </button>
                </div>
                <table class="table  border">
                    ...
                    <tbody>
                        ...
                        <tr class="text-center">
                            ...
                            <td>
                                <!-- <a href="/employee_detail?id={{$employee->id}}" class="badge text-white text-bg-primary">
                                Parameter
                            </a> |  -->
                                <span class="badge text-white text-bg-warning edit-link" data-bs-toggle="modal" data-bs-target="#editModal" data-id="{{ $employee->id }}">
                                    Edit
                                </span> |
                                <span class="badge text-white text-bg-danger delete-link" data-bs-toggle="modal" data-bs-target="#exampleModal2" data-id="{{ $employee->id }}">
                                    Delete
                                </span>
                            </td>
                        </tr>
                ...
                <div class="pagination">{!! $originalData->links() !!}</div>
            </div>
        </div>
    </div>
    ...
    <div class="modal fade" id="exampleModal2" tabindex="-1" aria-labelledby="exampleModal2Label" aria-hidden="true">
        <div class="modal-dialog">
            <form method="POST">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <h1 class="modal-title fs-5" id="exampleModal2Label">Hapus Guru</h1>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        Hapus Guru ?
